...
categoryRoutes.post("/changeStatus", requirePermission(['categories', 'category-master'], "edit"), categoryController.CategoryChangeStatus);
categoryRoutes.post("/multipleChangeStatus", requirePermission(['categories', 'category-master'], "delete"), categoryController.multiplecategoryChangeStatus);
