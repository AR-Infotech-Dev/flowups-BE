...
export const VIEW_ALL_ROLE_SLUGS = new Set(["admin", "superadmin", "super_admin"]);
...
export const isSuperAdminRole = (userOrRole = "") =>
  SUPER_ADMIN_ROLE_SLUGS.has(getRoleSlug(userOrRole));

export const isAdminRole = (userOrRole = "") =>
  ADMIN_ROLE_SLUGS.has(getRoleSlug(userOrRole));

export const canViewAllByRole = (userOrRole = "") =>
  VIEW_ALL_ROLE_SLUGS.has(getRoleSlug(userOrRole));
